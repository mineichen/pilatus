...
) -> BoxFuture<'a, JoinHandle<Result<(), anyhow::Error>>>
             + Send);
        ...
        runner
            .run_devices(
                ...
                &mut |_, changes| {
                    ...
                    async {
                        changes
                            .into_data_if_no_changes()
                            .expect("Should have no changes")
                    }
                    .boxed()
                },
